 ...
 * Description: 聚合数据短信API接口测试
 * date: 2019.10.13 14:56
 *
 * @author dell
 */
...
//            params.put("mobile","19861800995");//接受短信的用户手机号码
//            params.put("tpl_id","191715");//您申请的短信模板ID，根据实际情况修改
//            params.put("tpl_value","#code#=1111");//您设置的模板变量，根据实际情况修改
